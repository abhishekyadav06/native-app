...
exports.sendMail = functions.https.onRequest((req, res) => {
    cors(req, res, () => {
        ...
        const mailOptions = {
            ...
            +'email :'+ req.body.email+ 'mobile :' + req.body.mobile + 'Please communicate with the requestor to give the free meal. Thank you.'
        };
...
exports.sendMail_recipient = functions.https.onRequest((req, res) => {
    cors(req, res, () => {
        ...
        const mailOptions = {
            ...
            +'email :'+ req.body.donoremail+ 'mobile :' + req.body.donormobile + 'Please communicate with donor to get the free meal. Thank you.'
        };
